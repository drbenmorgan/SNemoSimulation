...
namespace mctools {
  ...
  namespace g4 {
    ...
    bool
    sensitive_detector::is_drop_zero_energy_deposit_steps() const
    {
      return _drop_zero_energy_deposit_steps_;
    }

    void
    sensitive_detector::set_drop_zero_energy_deposit_steps(bool drop_)
    {
    ...
    void
    sensitive_detector::set_track_gamma(bool track_gamma_)
    {
    ...
    void
    sensitive_detector::set_track_optical_photon(bool track_op_)
    {
    ...
    void
    sensitive_detector::set_track_neutron(bool track_neutron_)
    {
    ...
    bool
    sensitive_detector::has_manager() const
    {
      return _manager_ != 0;
    }

    void
    sensitive_detector::set_manager(manager& manager_)
    {
      _manager_ = &manager_;
      return;
    }
    ...
    void
    sensitive_detector::set_record_delta_ray_from_alpha(bool flag_)
    {
    ...
    void
    sensitive_detector::set_record_track_id(bool record_)
    {
    ...
    void
    sensitive_detector::set_record_step_length(bool record_)
    {
    ...
    void
    sensitive_detector::set_record_primary_particle(bool record_)
    {
    ...
    void
    sensitive_detector::set_record_major_track(bool record_)
    {
    ...
    void
    sensitive_detector::set_major_track_minimum_energy(double major_)
    {
    ...
    void
    sensitive_detector::set_record_creator_process(bool record_)
    {
    ...
    void
    sensitive_detector::set_record_creator_category(bool record_)
    {
    ...
    void
    sensitive_detector::set_record_material(bool record_)
    {
    ...
    void
    sensitive_detector::set_record_sensitive_category(bool record_)
    {
    ...
    void
    sensitive_detector::set_record_momentum(bool record_)
    {
    ...
    void
    sensitive_detector::set_record_kinetic_energy(bool record_)
    {
    ...
    void
    sensitive_detector::set_record_boundaries(bool record_)
    {
    ...
    int
    sensitive_detector::get_HCID() const
    {
      return _HCID_;
    }

    void
    sensitive_detector::set_HCID(int new_value_)
    {
      _HCID_ = new_value_;
      return;
    }
    ...
    sensitive_detector::grab_hit_processor(const std::string& name_)
    {
      ...
      DT_THROW_IF(
        found == _hit_processors_.end(), std::logic_error, "No '" << name_ << "' hit processor !");
      return *found->second;
    }

    void
    sensitive_detector::add_hit_processor(const std::string& name_,
                                          mctools::base_step_hit_processor& shp_)
    {
      DT_THROW_IF(_hit_processors_.find(name_) != _hit_processors_.end(),
                  std::logic_error,
                  "This sensitive detector '" << _sensitive_category_ << "' already has a '"
                                              << name_ << "' hit processor !");
    ...
    bool
    sensitive_detector::has_hit_processor(const std::string& name_) const
    {
      return (_hit_processors_.find(name_) != _hit_processors_.end());
    }

    void
    sensitive_detector::attach_logical_volume(const std::string& log_volume_name_)
    {
    ...
    std::string
    sensitive_detector::make_hit_collection_name(const std::string& name_)
    {
    ...
    void
    sensitive_detector::set_record_g4_volume_properties(bool flag_)
    {
    ...
    bool
    sensitive_detector::is_record_g4_volume_properties() const
    {
      return _record_g4_volume_properties_;
    }

    const std::string&
    sensitive_detector::get_sensitive_category() const
    {
      return _sensitive_category_;
    }

    unsigned int
    sensitive_detector::get_hits_buffer_capacity() const
    {
      return _hits_buffer_capacity_;
    }

    void
    sensitive_detector::set_hits_buffer_capacity(unsigned int capacity_)
    {
      if (capacity_ > 0) {
    ...
    void
    sensitive_detector::configure(const datatools::properties& config_)
    {
        ...
        if (config_.has_key(mtme_key)) {
          ...
          DT_THROW_IF(e_min < 0,
                      ...
                      "Invalid minimum energy for major track mode "
                        << "for sensitive detector '" << _sensitive_category_ << "' !");
...

      {
        ...
        if (config_.has_key(key)) {
          ...
          DT_THROW_IF(cap < 0,
                      std::logic_error,
                      "Invalid buffer size for sensitive detector '" << _sensitive_category_
                                                                     << "' !");
    ...
    void
    sensitive_detector::_set_defaults()
    {
      _track_gamma_ = true;
    ...
    void
    sensitive_detector::Initialize(G4HCofThisEvent* /*some_hit_collections_*/)
    {
      ...
      if (_hits_buffer_.size() == 0) {
        ...
        DT_LOG_NOTICE(_logprio(),
                      "Setup the buffer of hits for detector '"
                        << _sensitive_category_ << "' "
      ...
      if (_record_delta_ray_from_alpha_ || _record_track_id_ || _record_primary_particle_ ||
          _record_major_track_ || _record_creator_process_ || _record_creator_category_) {
      ...
      // cerr << datatools::io::devel << "snemo::g4::sensitive_detector::Initialize: " << "Exiting."
      // << endl;
      return;
    }

    void
    sensitive_detector::EndOfEvent(G4HCofThisEvent* some_hit_collections_)
    {
      ...
      if (_used_hits_count_ > 0) {
        ...
        if (_hits_collection_ == 0) {
          _hits_collection_ =
            new sensitive_hit_collection(SensitiveDetectorName, collectionName[0]);
          // cerr << datatools::io::devel << "snemo::g4::sensitive_detector::EndOfEvent: "
        ...
        sensitive_hit_collection::hit_collection_type& the_hits = _hits_collection_->grab_hits();
    ...
    G4bool
    sensitive_detector::ProcessHits(G4Step* step_, G4TouchableHistory* /*touchable_history_*/)
    {
      ...
      */
      ...
      if (use_track_info) {
        ...
        // if (_record_creator_category_ && !
        // _track_info_ptr_->get_creator_sensitive_category().empty()) {
      ...
      if (_record_sensitive_category_) {
        static std::string sensitive_category_key = geomtools::sensitive::make_key(
          geomtools::sensitive::constants::instance().SENSITIVE_CATEGORY_PROPERTY);
    ...
    void
    sensitive_detector::tree_dump(std::ostream& out_,
                                  ...
                                  bool /*inherit_*/) const
    {
      ...
      out_ << indent << datatools::i_tree_dumpable::tag << "Logging priority : '"
           << datatools::logger::get_priority_label(_logging_priority) << "'" << std::endl;
      out_ << indent << datatools::i_tree_dumpable::tag << "Category         : '"
           << _sensitive_category_ << "'" << std::endl;
      // Logical volumes
      {
        out_ << indent << datatools::i_tree_dumpable::tag
             << "Attached logical volumes    : " << _attached_logical_volumes_.size() << std::endl;
        for (std::list<std::string>::const_iterator ilog = _attached_logical_volumes_.begin();
             ilog != _attached_logical_volumes_.end();
             ++ilog) {
          ...
          out_ << "Logical[" << std::distance(_attached_logical_volumes_.begin(), ilog) << "]: '"
               << *ilog << "'" << std::endl;
        }
      }
      ...
      // Flags
      {
        out_ << indent << datatools::i_tree_dumpable::tag << "Drop zero energy deposit    : "
             << (_drop_zero_energy_deposit_steps_ ? "Yes" : "No") << std::endl;

        out_ << indent << datatools::i_tree_dumpable::tag
             << "Track gamma                 : " << (_track_gamma_ ? "Yes" : "No") << std::endl;

        out_ << indent << datatools::i_tree_dumpable::tag
             << "Track optical photon        : " << (_track_optical_photon_ ? "Yes" : "No")
             << std::endl;

        out_ << indent << datatools::i_tree_dumpable::tag
             << "Track neutron               : " << (_track_neutron_ ? "Yes" : "No") << std::endl;

        out_ << indent << datatools::i_tree_dumpable::tag
             << "Record volume properties    : " << (_record_g4_volume_properties_ ? "Yes" : "No")
             << std::endl;

        out_ << indent << datatools::i_tree_dumpable::tag
             << "Record momentum             : " << (_record_momentum_ ? "Yes" : "No") << std::endl;

        out_ << indent << datatools::i_tree_dumpable::tag
             << "Record kinetic energy       : " << (_record_kinetic_energy_ ? "Yes" : "No")
             << std::endl;

        out_ << indent << datatools::i_tree_dumpable::tag
             << "Record primary particle     : " << (_record_primary_particle_ ? "Yes" : "No")
             << std::endl;

        out_ << indent << datatools::i_tree_dumpable::tag
             << "Record track id             : " << (_record_track_id_ ? "Yes" : "No") << std::endl;

        out_ << indent << datatools::i_tree_dumpable::tag
             << "Record creator process      : " << (_record_creator_process_ ? "Yes" : "No")
             << std::endl;

        out_ << indent << datatools::i_tree_dumpable::tag
             << "Record major track          : " << (_record_major_track_ ? "Yes" : "No");

        if (_record_major_track_) {
          out_ << "(Emin > " << _major_track_minimum_energy_ / CLHEP::keV << " keV)" << std::endl;
        } else {
          out_ << std::endl;
        }

        out_ << indent << datatools::i_tree_dumpable::tag
             << "Record material name        : " << (_record_material_ ? "Yes" : "No") << std::endl;

        out_ << indent << datatools::i_tree_dumpable::tag
             << "Record delta ray from alpha : " << (_record_delta_ray_from_alpha_ ? "Yes" : "No")
             << std::endl;

        out_ << indent << datatools::i_tree_dumpable::tag << "Track info pointer          : ";
        if (_track_info_ptr_ != 0)
          out_ << _track_info_ptr_;
        else
          out_ << "Not allocated";
        out_ << std::endl;

        out_ << indent << datatools::i_tree_dumpable::tag << "Parent track info pointer   : ";
        if (_parent_track_info_ptr_ != 0)
          out_ << _parent_track_info_ptr_;
        else
          out_ << "Not allocated";
        out_ << std::endl;

        out_ << indent << datatools::i_tree_dumpable::tag
             << "Hits buffer capacity        : " << _hits_buffer_capacity_ << std::endl;
      }
      ...
      {
        out_ << indent << datatools::i_tree_dumpable::last_tag << "Step hit processors         : ";

        if (_hit_processors_.size() == 0) {
          out_ << "No" << std::endl;
        } else {
          out_ << _hit_processors_.size() << std::endl;
          for (hit_processor_dict_type::const_iterator ihp = _hit_processors_.begin();
            ...
            out_ << "Processor[" << std::distance(_hit_processors_.begin(), ihp) << "]: '"
                 << hp_name << "' @ " << hp << " with hit category '" << hp->get_hit_category()
                 << "'" << std::endl;
          }
        }
      }
...
DOCD_CLASS_IMPLEMENT_LOAD_BEGIN(mctools::g4::sensitive_detector, ocd_)
{
...

  {
    ...
    cpd.set_name_pattern("sensitive.drop_zero_energy_deposit_steps")
      .set_terse_description(
        "Do not record *zero energy deposit* hits from particles other than photons and neutrons")
      .set_traits(datatools::TYPE_BOOLEAN)
      .set_mandatory(false)
...

  {
    ...
    cpd.set_name_pattern("sensitive.record_alpha_quenching")
      .set_terse_description("Record the 'track.delta_ray_from_alpha' flag for secondary "
                             "ionization electrons from an alpha particle")
      .set_traits(datatools::TYPE_BOOLEAN)
      .set_mandatory(false)
      .set_long_description("Example::                                              \n"
                            "                                                       \n"
...

  {
    ...
    cpd.set_name_pattern("sensitive.record_kinetic_energy")
      .set_terse_description(
        "Record the 'track.start_kinetic_energy' and 'track.stop_kinetic_energy' real properties")
      .set_traits(datatools::TYPE_BOOLEAN)
      .set_mandatory(false)
      .set_long_description("Example::                                              \n"
                            "                                                       \n"
...

  {
    ...
    cpd.set_name_pattern("sensitive.record_g4_volume_infos")
      .set_terse_description(
        "Record the 'g4_volume.name' string and 'g4_volume.copy_number' integer properties")
      .set_traits(datatools::TYPE_BOOLEAN)
      .set_mandatory(false)
      .set_long_description("Example::                                              \n"
                            "                                                       \n"
...

  {
    ...
    cpd.set_name_pattern("sensitive.hits_buffer_capacity")
      .set_terse_description(
        "Setup the initial capacity of the sensitive hit buffer for memory optimization")
