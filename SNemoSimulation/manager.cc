...
namespace mctools {
  namespace g4 {
    ...
    const std::string&
    manager::vertex_generator_label()
    {
    ...
    const std::string&
    manager::default_prng_states_file()
    {
    ...
    void
    manager::initialize(const datatools::multi_properties& multi_config_)
    {
    ...
    bool
    manager::is_initialized() const
    {
      return _initialized_;
    }

    bool
    manager::is_automatic() const
    {
    ...
    //----------------------------------------------------------------------
    bool
    manager::has_service_manager() const
    {
      return _service_manager_ != nullptr;
    }

    void
    manager::set_service_manager(datatools::service_manager& sm)
    {
    ...
    manager::grab_service_manager()
    {
      DT_THROW_IF(
        _service_manager_ == nullptr, std::logic_error, "No service manager is available !");
      return *_service_manager_;
    }

    const datatools::service_manager&
    manager::get_service_manager() const
    {
      DT_THROW_IF(
        _service_manager_ == nullptr, std::logic_error, "No service manager is available !");
      return *_service_manager_;
    ...
    bool
    manager::has_external_geom_manager() const
    {
      return _external_geom_manager_ != nullptr;
    }

    void
    manager::set_external_geom_manager(const geomtools::manager& gm)
    {
      DT_THROW_IF(_initialized_, std::logic_error, "Operation prohibited ! Manager is locked !");
      ...
      DT_THROW_IF(
        !gm.is_initialized(), std::logic_error, "External geometry manager is not initialized !");
      _external_geom_manager_ = &gm;
    }

    const geomtools::manager&
    manager::get_geom_manager() const
    {
    ...
    //----------------------------------------------------------------------
    void
    manager::set_event_generator_name(const std::string& eg_name_)
    {
      DT_THROW_IF(_initialized_, std::logic_error, "Operation prohibited ! Manager is locked !");
      _eg_name_ = eg_name_;
    }
    ...
    void
    manager::set_event_generator_seed(int seed_)
    {
    ...
    const genbb::manager&
    manager::get_eg_manager() const
    {
      return _eg_manager_;
    }

    genbb::manager&
    manager::grab_eg_manager()
    {
      return _eg_manager_;
    }

    bool
    manager::has_event_generator() const
    {
      return _event_generator_ != 0;
    }

    const genbb::i_genbb&
    manager::get_event_generator() const
    {
      DT_THROW_IF(
        !this->has_event_generator(), std::logic_error, "No event generator is available !");
      return *_event_generator_;
    }

    void
    manager::set_vertex_generator_name(const std::string& vg_name_)
    {
      DT_THROW_IF(_initialized_, std::logic_error, "Operation prohibited ! Manager is locked !");
      _vg_name_ = vg_name_;
    }
    ...
    void
    manager::set_vertex_generator_seed(int seed_)
    {
    ...
    const genvtx::manager&
    manager::get_vg_manager() const
    {
      return _vg_manager_;
    }

    genvtx::manager&
    manager::grab_vg_manager()
    {
      return _vg_manager_;
    }

    bool
    manager::has_vertex_generator() const
    {
      return _vertex_generator_ != 0;
    }

    const genvtx::i_vertex_generator&
    manager::get_vertex_generator() const
    {
      DT_THROW_IF(
        !this->has_vertex_generator(), std::logic_error, "No vertex generator is available !");
      return *_vertex_generator_;
    }

    event_action&
    manager::grab_user_event_action()
    {
      DT_THROW_IF(!_initialized_, std::logic_error, "Manager is not initialized !");
    ...
    uint32_t
    manager::get_number_of_events() const
    {
      return _number_of_events_;
    }

    void
    manager::set_number_of_events(uint32_t n)
    {
      DT_THROW_IF(_initialized_, std::logic_error, "Operation prohibited ! Manager is locked !");
      DT_THROW_IF(
        n < NUMBER_OF_EVENTS_LOWER_LIMIT, std::domain_error, "Invalid 'zero' number of events !");
    ...
    bool
    manager::has_number_of_events_modulo() const
    {
      return _number_of_events_modulo_ > run_action::NUMBER_OF_EVENTS_MODULO_NONE;
    }

    int
    manager::get_number_of_events_modulo() const
    {
      return _number_of_events_modulo_;
    }

    void
    manager::set_number_of_events_modulo(int a_m)
    {
    ...
    void
    manager::set_use_run_header_footer(bool a_use_run_header_footer)
    {
      _use_run_header_footer_ = a_use_run_header_footer;
    }

    bool
    manager::using_run_header_footer() const
    {
      return _use_run_header_footer_;
    }

    bool
    manager::is_batch() const
    {
      return !is_interactive();
    }

    bool
    manager::is_interactive() const
    {
      return _interactive_;
    }

    void
    manager::set_interactive(bool new_value_)
    {
      DT_THROW_IF(_initialized_, std::logic_error, "Operation prohibited ! Manager is locked !");
    ...
    void
    manager::set_g4_visualization(bool new_value_)
    {
      DT_THROW_IF(_initialized_, std::logic_error, "Operation prohibited ! Manager is locked !");
#ifdef G4VIS_USE
    ...
    bool
    manager::has_g4_visualization() const
    {
      return is_interactive() && _g4_visualization_;
    }

    bool
    manager::has_g4_macro() const
    {
      return !_g4_macro_.empty();
    }

    const std::string&
    manager::get_g4_macro() const
    {
      return _g4_macro_;
    }

    void
    manager::set_g4_macro(const std::string& g4_macro_)
    {
      DT_THROW_IF(_initialized_, std::logic_error, "Operation prohibited ! Manager is locked !");
    ...
    void
    manager::set_use_track_history(const bool use)
    {
      _use_track_history_ = use;
    }

    bool
    manager::has_track_history() const
    {
      return _use_track_history_;
    }

    const track_history&
    manager::get_track_history() const
    {
      return _track_history_;
    }

    track_history&
    manager::grab_track_history()
    {
      return _track_history_;
    }

    bool
    manager::forbids_private_hits() const
    {
      return _forbid_private_hits_;
    }

    void
    manager::set_forbid_private_hits(bool a_forbid)
    {
      DT_THROW_IF(_initialized_, std::logic_error, "Operation prohibited ! Manager is locked !");
    ...
    void
    manager::set_dont_save_no_sensitive_hit_events(bool a_dont_save)
    {
      DT_THROW_IF(_initialized_, std::logic_error, "Operation prohibited ! Manager is locked !");
    ...
    bool
    manager::dont_save_no_sensitive_hit_events() const
    {
    ...
    //----------------------------------------------------------------------
    bool
    manager::has_simulation_ctrl() const
    {
      return _simulation_ctrl_ != 0;
    }

    void
    manager::set_simulation_ctrl(simulation_ctrl& a_simulation_ctrl)
    {
      DT_THROW_IF(_initialized_, std::logic_error, "Operation prohibited ! Manager is locked !");
    ...
    void
    manager::reset_simulation_ctrl()
    {
      DT_THROW_IF(_initialized_, std::logic_error, "Operation prohibited ! Manager is locked !");
      _simulation_ctrl_ = 0;
    }

    const simulation_ctrl&
    manager::get_simulation_ctrl() const
    {
      DT_THROW_IF(
        !has_simulation_ctrl(), std::logic_error, "Manager has no 'simulation ctrl' object !");
      return *_simulation_ctrl_;
    }

    simulation_ctrl&
    manager::grab_simulation_ctrl()
    {
      DT_THROW_IF(
        !has_simulation_ctrl(), std::logic_error, "Manager has no 'simulation ctrl' object !");
      return *_simulation_ctrl_;
    ...
    //----------------------------------------------------------------------
    mygsl::rng&
    manager::grab_vg_prng()
    {
      return _vg_prng_;
    }

    mygsl::rng&
    manager::grab_eg_prng()
    {
      return _eg_prng_;
    }

    mygsl::rng&
    manager::grab_shpf_prng()
    {
      return _shpf_prng_;
    }

    const mygsl::rng&
    manager::get_mgr_prng() const
    {
      return _mgr_prng_;
    }

    mygsl::rng&
    manager::grab_mgr_prng()
    {
      return _mgr_prng_;
    }

    const g4_prng&
    manager::get_g4_prng() const
    {
      return _g4_prng_;
    }

    g4_prng&
    manager::grab_g4_prng()
    {
      return _g4_prng_;
    }

    const mygsl::seed_manager&
    manager::get_seed_manager() const
    {
      return _seed_manager_;
    }

    mygsl::seed_manager&
    manager::grab_seed_manager()
    {
      return _seed_manager_;
    }

    const mygsl::prng_state_manager&
    manager::get_state_manager() const
    {
      return _prng_state_manager_;
    }

    mygsl::prng_state_manager&
    manager::grab_state_manager()
    {
      DT_THROW_IF(_initialized_, std::logic_error, "Operation prohibited ! Manager is locked !");
      return _prng_state_manager_;
    }
    ...
    void
    manager::record_current_prng_states()
    {
      // G4 PRNG :
      ...
      if (is_debug())
        _prng_state_manager_.dump(std::clog);
      _prng_state_manager_.store();
    }

    void
    manager::set_prng_state_save_modulo(int a_modulo)
    {
      if (a_modulo < 1) {
    ...
    int
    manager::get_prng_state_save_modulo() const
    {
      return _prng_state_save_modulo_;
    }

    bool
    manager::has_prng_state_save_modulo() const
    {
      return _prng_state_save_modulo_ > 0;
    }

    void
    manager::reset_output_prng_seeds_file()
    {
      _output_prng_seeds_file_ = "";
    }

    void
    manager::reset_input_prng_seeds_file()
    {
      _input_prng_seeds_file_ = "";
    }

    bool
    manager::has_input_prng_seeds_file() const
    {
      return !_input_prng_seeds_file_.empty();
    }

    const std::string&
    manager::get_input_prng_seeds_file() const
    {
      return _input_prng_seeds_file_;
    }

    void
    manager::set_input_prng_seeds_file(const std::string& fn_)
    {
      _input_prng_seeds_file_ = fn_;
    }

    bool
    manager::has_output_prng_seeds_file() const
    {
      return !_output_prng_seeds_file_.empty();
    }

    const std::string&
    manager::get_output_prng_seeds_file() const
    {
      return _output_prng_seeds_file_;
    }

    void
    manager::set_output_prng_seeds_file(const std::string& fn_)
    {
      _output_prng_seeds_file_ = fn_;
    }

    void
    manager::reset_output_prng_states_file()
    {
      _output_prng_states_file_ = "";
    }

    const std::string&
    manager::get_output_prng_states_file() const
    {
      return _output_prng_states_file_;
    }

    bool
    manager::has_output_prng_states_file() const
    {
      return !_output_prng_states_file_.empty();
    }

    void
    manager::set_output_prng_states_file(const std::string& fn_)
    {
      _output_prng_states_file_ = fn_;
    }

    void
    manager::reset_input_prng_states_file()
    {
      _input_prng_states_file_ = "";
    }

    const std::string&
    manager::get_input_prng_states_file() const
    {
      return _input_prng_states_file_;
    }

    bool
    manager::has_input_prng_states_file() const
    {
      return !_input_prng_states_file_.empty();
    }

    void
    manager::set_input_prng_states_file(const std::string& fn_)
    {
      _input_prng_states_file_ = fn_;
    }

    void
    manager::set_shpf_prng_seed(int seed_)
    {
      DT_THROW_IF(_initialized_, std::logic_error, "Operation prohibited ! Manager is locked !");
    ...
    void
    manager::set_mgr_prng_seed(int rseed_)
    {
      DT_THROW_IF(_initialized_, std::logic_error, "Operation prohibited ! Manager is locked !");
      if (rseed_ < 0) {
    ...
    bool
    manager::has_mgr_prng_seed() const
    {
      return _mgr_prng_seed_ != mygsl::random_utils::SEED_INVALID;
    }

    int
    manager::get_mgr_prng_seed() const
    {
      return _mgr_prng_seed_;
    }

    bool
    manager::has_init_seed_method() const
    {
      return !_init_seed_method_.empty();
    }

    void
    manager::set_init_seed_method(const std::string& method_)
    {
      _init_seed_method_ = method_;
    }

    const std::string&
    manager::get_init_seed_method() const
    {
    ...
    void
    manager::set_output_data_file(const std::string& fn_)
    {
      _output_data_file_ = fn_;
    }

    bool
    manager::using_time_stat() const
    {
      return _use_time_stat_;
    }

    void
    manager::set_using_time_stat(bool new_value_)
    {
      DT_THROW_IF(_initialized_, std::logic_error, "Operation prohibited ! Manager is locked !");
      _use_time_stat_ = new_value_;
    }

    const manager::CT_map&
    manager::get_CT_map() const
    {
      return _CTs_;
    }
    ...
    //----------------------------------------------------------------------
    bool
    manager::has_supported_output_profile(const std::string& profile_id_) const
    {
      return _supported_output_profile_ids_.find(profile_id_) !=
             _supported_output_profile_ids_.end();
    }

    void
    manager::add_supported_output_profile(const std::string& profile_id_,
                                          const std::string& description_)
    {
      DT_THROW_IF(_initialized_, std::logic_error, "Operation prohibited ! Manager is locked !");
      std::string profile_id = profile_id_;
      boost::trim(profile_id);
      DT_THROW_IF(profile_id.empty(), std::logic_error, "Empty output profile Id !");
      ...
      DT_THROW_IF(has_supported_output_profile(profile_id),
                  std::logic_error,
    ...
    manager::get_supported_output_profiles() const
    {
      return _supported_output_profile_ids_;
    }

    bool
    manager::has_activated_output_profiles() const
    {
      return _activated_output_profile_ids_.size() > 0;
    }

    bool
    manager::has_activated_output_profile(const std::string& id) const
    {
      return _activated_output_profile_ids_.count(id) == 1;
    }

    void
    manager::activate_output_profile(const std::string& id)
    {
      DT_THROW_IF(_initialized_, std::logic_error, "Operation prohibited ! Manager is locked !");
    ...
    void
    manager::deactivate_output_profile(const std::string& id)
    {
      DT_THROW_IF(_initialized_, std::logic_error, "Operation prohibited ! Manager is locked !");
    ...
    void
    manager::set_output_profiles_activation_rule(const std::string& rule_)
    {
      DT_THROW_IF(_initialized_, std::logic_error, "Operation prohibited ! Manager is locked !");
    ...
    void
    manager::apply_output_profiles_activation_rule(const std::string& rule)
    {
      DT_THROW_IF(_initialized_, std::logic_error, "Operation prohibited ! Manager is locked !");
      if (rule.empty())
        return;
    ...
    void
    manager::fetch_activated_output_profile_ids(std::vector<std::string>& ids) const
    {
    ...
    manager::get_activated_output_profile_ids() const
    {
    ...
    void
    manager::dump_base(std::ostream& os, const std::string& title, const std::string& iIndent) const
    {
      std::string indent;
      if (!iIndent.empty())
        indent = iIndent;
      ...
      os << indent << "|-- G4 PRNG name: '"
         ...
         << std::endl;
      os << indent << "|-- PRNG seeds input file:   '" << _input_prng_seeds_file_ << "' "
         << std::endl;
      os << indent << "|-- PRNG seeds output file:  '" << _output_prng_seeds_file_ << "' "
         << std::endl;
      os << indent << "|-- PRNG states input file:  '" << _input_prng_states_file_ << "' "
         << std::endl;
      os << indent << "|-- PRNG states output file: '" << _output_prng_states_file_ << "' "
         << std::endl;
    ...
    {
      if (_use_time_stat_) {
        for (CT_map::iterator i = _CTs_.begin(); i != _CTs_.end(); i++) {
    ...
    {
      // Main manager:
      const datatools::properties& manager_config = _multi_config_->get("manager").get_properties();
        ...
        if (boost::filesystem::exists(input_prng_seeds_file)) {
          ...
          DT_THROW_IF(!seeds_file,
                      ...
                      "Invalid input or format ! "
                        << "Cannot load the PRNG seed dictionary from file '"
                        << input_prng_seeds_file << "' !");
        } else {
          DT_THROW(std::runtime_error,
                   "No PRNG seed dictionary input file '" << input_prng_seeds_file
                                                          << "' to be loaded.");
        }
      }
      ...
      if (get_init_seed_method() == "current_time") {
        ...
        DT_THROW(std::logic_error,
                 "Initialization method '" << get_init_seed_method()
                                           << "' is unknown or not supported !");
      }
      DT_LOG_DEBUG(_logprio(),
                   "Initialization of PRNG seeds is based on the '" << get_init_seed_method()
                                                                    << "' method");
    ...
    void
    manager::_init_vertex_generator()
    {
      // Vertex generator:
      ...
      if (_multi_config_->has_section("vertex_generator")) {
        ...
        DT_THROW_IF(!_vg_manager_.has_generator(vg_name),
                    std::logic_error,
                    "Cannot find vertex generator named '" + vg_name + "' !");
    ...
    manager::_init_event_generator()
    {
      ...
      if (primary_generator_config.has_key("manager.config")) {
        ...
        datatools::properties::read_config(event_gtor_prop_filename, event_gtor_config);
    ...
    void
    manager::_init_detector_construction()
    {
      // Detector construction:
      ...
      _user_detector_construction_->grab_step_hit_processor_factory().set_external_prng(
        _shpf_prng_);
    ...
    manager::_init_physics_list()
    {
      ...
      if (is_debug())
        _user_physics_list_->tree_dump(std::clog);
    }

    void
    manager::_init_run_action()
    {
    ...
    manager::_init_event_action()
    {
      ...
      _user_event_action_ = new event_action(*_user_run_action_, *_user_detector_construction_);
      _user_event_action_->initialize(event_action_config);
      _g4_run_manager_->SetUserAction(_user_event_action_);
    }

    void
    manager::_init_primary_generator_action()
    {
    ...
    manager::_init_seeds()
    {
      ...
      if (_seed_manager_.has_seed(g4_manager_label())) {
        ...
        DT_LOG_NOTICE(_logprio(),
                      "Using registered seed for '" << g4_manager_label() << "' : " << seed);
      }
      ...
      if (_seed_manager_.has_seed(vertex_generator_label())) {
        ...
        DT_LOG_NOTICE(_logprio(),
                      "Using registered seed for '" << vertex_generator_label() << "' : " << seed);
      }
      ...
      if (_seed_manager_.has_seed(event_generator_label())) {
        ...
        DT_LOG_NOTICE(_logprio(),
                      "Using registered seed for '" << event_generator_label() << "' : " << seed);
      }
      ...
      if (_seed_manager_.has_seed(shpf_label())) {
        ...
        DT_LOG_NOTICE(_logprio(), "Using registered seed for '" << shpf_label() << "' : " << seed);
      }
      ...
      if (has_output_prng_seeds_file()) {
        ...
        DT_LOG_NOTICE(_logprio(),
                      "Saving the Random Number Generator seeds in file '" << seeds_filename
                                                                           << "'...");
    ...
    void
    manager::_init_prngs_states()
    {
      // Load the PRNG internal states buffers :
      if (has_input_prng_states_file()) {
        DT_LOG_NOTICE(_logprio(),
                      "Loading PRNG internal states from file '" << get_input_prng_states_file()
                                                                 << "'...");
      ...
      if (!_prng_state_manager_.has_state(g4_manager_label())) {
        _prng_state_manager_.add_state(g4_manager_label(), _mgr_prng_.get_internal_state_size());
      }
      // Vertex generator PRNG :
      ...
      if (!_prng_state_manager_.has_state(shpf_label())) {
        _prng_state_manager_.add_state(shpf_label(), _shpf_prng_.get_internal_state_size());
      }
      ...
      if (has_input_prng_states_file()) {
        ...
        // Vertex generator PRNG :
        _vg_prng_.from_buffer(
          _prng_state_manager_.get_state(vertex_generator_label()).state_buffer);
    ...
    manager::_init_prngs()
    {
      ...
      //     DT_LOG_NOTICE(_logprio(), "Random Number Generator internal state was restored from
      //     file '"
      //                   << rsf << "'...");
      //     needs_seed = false;
      ...
      //   } else {
      //     DT_THROW(std::logic_error,
      //              "Random Number Generator initial state file '" << rsf.c_str() << "' does not
      //              exist !");
      //   }
      // }
      ...
      */
      ...
      DT_LOG_NOTICE(_logprio(), "Setting the HepRandomEngine to '" << _g4_prng_.name() << "'...");
    }

    void
    manager::_init_time_stat()
    {
