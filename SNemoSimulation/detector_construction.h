...
namespace mctools {
  ...
  namespace g4 {
    ...
    private:
      ...
      bool _abort_on_error_ = true;                     //!< Flag to force abortion on error while building the geometry setup
      ...
      const emfield::electromagnetic_field_manager * _em_field_manager_ = nullptr; //!< Reference to the EM field manager
