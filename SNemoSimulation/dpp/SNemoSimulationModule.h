...
namespace mctools {
  ...
  namespace g4 {
    ...
    public:
      /// Constructor
      SNemoSimulationModule(
        datatools::logger::priority logging_priority = datatools::logger::PRIO_FATAL);
    ...
    private:
      ...
      const geomtools::manager*
        geometryManagerRef_; //!< Non-mutable reference to the geometry manager
