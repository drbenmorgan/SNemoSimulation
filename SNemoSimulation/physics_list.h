...
#ifndef SNEMOSIMULATION_G4_PHYSICS_LIST_H
#define SNEMOSIMULATION_G4_PHYSICS_LIST_H 1
...
DOCD_CLASS_DECLARATION(snemo::g4::physics_list)

#endif // SNEMOSIMULATION_G4_PHYSICS_LIST_H
