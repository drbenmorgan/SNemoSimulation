...
namespace mctools {
  ...
  namespace g4 {
    ...
    loggable_support::~loggable_support() { return; }

    loggable_support::loggable_support(datatools::logger::priority p) { _logging_priority = p; }

    datatools::logger::priority
    loggable_support::_logprio() const
    {
      return _logging_priority;
    }

    datatools::logger::priority
    loggable_support::get_logging_priority() const
    {
      return _logging_priority;
    }

    void
    loggable_support::set_debug(bool debug_)
    {
      if (debug_) {
    ...
    bool
    loggable_support::is_debug() const
    {
      return _logging_priority >= datatools::logger::PRIO_DEBUG;
    }

    void
    loggable_support::set_verbose(bool verbose_)
    {
      if (verbose_) {
    ...
    bool
    loggable_support::is_verbose() const
    {
      return _logging_priority >= datatools::logger::PRIO_NOTICE;
    }

    void
    loggable_support::set_logging_priority(const std::string& priority_label_)
    {
    ...
    void
    loggable_support::set_logging_priority(datatools::logger::priority p)
    {
      _logging_priority = p;
    }

    void
    loggable_support::_initialize_logging_support(const datatools::properties& config_)
    {
