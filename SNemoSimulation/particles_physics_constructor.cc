...
namespace snemo {
  ...
  namespace g4 {
    ...
    void
    particles_physics_constructor::_set_defaults()
    {
      // Bosons:
    ...
    void
    particles_physics_constructor::initialize(const datatools::properties& config_,
    ...
    void
    particles_physics_constructor::reset()
    {
      DT_LOG_TRACE(_logprio(), "Entering...");
    ...
    void
    particles_physics_constructor::tree_dump(std::ostream& out_,
                                             ...
                                             bool inherit_) const
    {
      ...
      out_ << indent << datatools::i_tree_dumpable::tag
           << "Use optical photons          : " << (_use_optical_photons_ ? "Yes" : "No")
           << std::endl;
      ...
      out_ << indent << datatools::i_tree_dumpable::tag
           << "Use strange baryons          : " << (_use_strange_baryons_ ? "Yes" : "No")
           << std::endl;

      out_ << indent << datatools::i_tree_dumpable::tag
           << "Use charm baryons            : " << (_use_charm_baryons_ ? "Yes" : "No")
           << std::endl;

      out_ << indent << datatools::i_tree_dumpable::tag
           << "Use bottom baryons           : " << (_use_bottom_baryons_ ? "Yes" : "No")
           << std::endl;
      ...
      out_ << indent << datatools::i_tree_dumpable::tag
           << "Use bottom mesons            : " << (_use_bottom_mesons_ ? "Yes" : "No")
           << std::endl;
      ...
      out_ << indent << datatools::i_tree_dumpable::tag
           << "Use light anti-nuclei        : " << (_use_light_anti_nuclei_ ? "Yes" : "No")
           << std::endl;
    ...
    void
    particles_physics_constructor::ConstructParticle()
    {
      DT_THROW_IF(!is_initialized(), std::logic_error, "Not initialized !");
    ...
    void
    particles_physics_constructor::_ConstructIons()
    {
      if (_use_light_nuclei_) {
    ...
    void
    particles_physics_constructor::_ConstructBosons()
    {
      // gammas
    ...
    void
    particles_physics_constructor::_ConstructLeptons()
    {
      // Light leptons e+/e- :
    ...
    void
    particles_physics_constructor::_ConstructMesons()
    {
    ...
    void
    particles_physics_constructor::_ConstructBaryons()
    {
      if (_use_nucleons_) {
      ...
      if (_use_bottom_baryons_) {
        ...
        DT_LOG_WARNING(
          _logprio(), "Geant4 version " << G4VERSION_NUMBER << " does not support bottom baryons.");
#endif // G4VERSION_NUMBER == 960
        ...
        DT_LOG_WARNING(_logprio(),
                       "Geant4 version " << G4VERSION_NUMBER
                                         << " does not support bottom anti-baryons.");
#endif // G4VERSION_NUMBER == 960
      }
      return;
    }
    ...
    void
    particles_physics_constructor::_ConstructUserLimits()
    {
 ...
 */
DOCD_CLASS_IMPLEMENT_LOAD_BEGIN(snemo::g4::particles_physics_constructor, ocd_)
{
  // The class name :
  ocd_.set_class_name("snemo::g4::particles_physics_constructor");

  // The class terse description :
  ocd_.set_class_description(
    "The Geant4 simulation manager particles definition physics constructor");
  ...
  ocd_.set_configuration_hints(
    "The configuration of a ``snemo::g4::particles_physics_constructor``  \n"
...
// Registration macro for class 'snemo::g4::particles_physics_constructor' :
DOCD_CLASS_SYSTEM_REGISTRATION(snemo::g4::particles_physics_constructor,
                               "snemo::g4::particles_physics_constructor")
