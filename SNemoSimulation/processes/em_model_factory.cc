...
namespace snemo {
  ...
  namespace g4 {
    ...
    namespace processes {
      ...
      bool
      em_model_factory::is_initialized() const
      {
        return _initialized_;
      }

      void
      em_model_factory::initialize()
      {
      ...
      bool
      em_model_factory::has_model_type(const std::string& model_type_id_) const
      {
      ...
      // static
      void
      em_model_factory::_change_model_name_(G4VEmModel& model_, const std::string& name_)
      {
      ...
      void
      em_model_factory::_registration()
      {
        _registration_base();
      ...
      void
      em_model_factory::_registration_base()
      {
      ...
      void
      em_model_factory::_registration_standard()
      {
        /*
          ...
          $ find source/processes/electromagnetic/standard/ -name "G4*Model*.hh" | cut -d/ -f6 | cut
          -d. -f1 > em_model_std.lis
        ...
        */
        ...
        _reg_.registration("GoudsmitSaundersonMsc",
                           boost::factory<G4GoudsmitSaundersonMscModel*>());
        ...
        _reg_.registration("ICRU49NuclearStopping",
                           boost::factory<G4ICRU49NuclearStoppingModel*>());
        _reg_.registration("PEEffectFluo", boost::factory<G4PEEffectFluoModel*>());
        _reg_.registration("eSingleCoulombScattering",
                           boost::factory<G4eSingleCoulombScatteringModel*>());
      ...
      // static
      const em_model_factory&
      em_model_factory::get_instance()
      {
      ...
      // static
      em_model_factory&
      em_model_factory::grab_instance()
      {
        return _instance_();
      }
