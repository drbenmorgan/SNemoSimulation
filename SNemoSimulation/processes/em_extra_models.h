/// \file SNemoSimulation/processes/em_extra_models.h
...
#ifndef SNEMOSIMULATION_G4_PROCESSES_EM_EXTRA_MODELS_H
#define SNEMOSIMULATION_G4_PROCESSES_EM_EXTRA_MODELS_H
  ...
  namespace g4 {
    ...
    namespace processes {
      ...
      public:
        ...
        /// * the empty string, "world", "World", "DefaultRegionForTheWorld": represent the default
        /// region associated
      ...
      private:
        ...
        std::string _model_type_id_; ///< The model type/class identifier as registered in some EM
                                     ///< model factory
...
// DOCD_CLASS_DECLARATION(snemo::g4::processes::em_extra_models)

#endif // SNEMOSIMULATION_G4_PROCESSES_EM_EXTRA_MODELS_H
