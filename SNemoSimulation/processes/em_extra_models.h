  ...
  namespace g4 {
    ...
    namespace processes {
      ...
      public:
        ...
        /// * the empty string, "world", "World", "DefaultRegionForTheWorld": represent the default region associated
      ...
      private:
        ...
        std::string _model_type_id_; ///< The model type/class identifier as registered in some EM model factory
