...
#ifndef SNEMOSIMULATION_G4_EVENT_ACTION_H
#define SNEMOSIMULATION_G4_EVENT_ACTION_H 1
...
namespace snemo {
  ...
  namespace g4 {
    ...
    private:
      ...
      // Working data:
      const detector_construction*
        _detector_construction_;              //!< Handle to the G4 detector construction
...
DOCD_CLASS_DECLARATION(snemo::g4::event_action)

#endif // SNEMOSIMULATION_G4_EVENT_ACTION_H
