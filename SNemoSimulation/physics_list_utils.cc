...
namespace snemo {
  ...
  namespace g4 {
    ...
    std::string
    get_builder_type_label(G4BuilderType type_)
    {
      if (type_ == bTransportation)
        return "transportation";
      else if (type_ == bElectromagnetic)
        return "electromagnetic";
      else if (type_ == bEmExtra)
        return "electromagnetic_extra";
      else if (type_ == bDecay)
        return "decay";
    ...
    G4BuilderType
    get_builder_type(const std::string& label_)
    {
      if (label_ == "transportation")
        return bTransportation;
      else if (label_ == "electromagnetic")
        return bElectromagnetic;
      else if (label_ == "electromagnetic_extra")
        return bEmExtra;
      else if (label_ == "decay")
        return bDecay;
    ...
    {
      DT_THROW_IF(!(status & STATUS_CREATED),
                  std::logic_error,
    ...
    void
    physics_constructor_proxy::ConstructParticle()
    {
    ...
    void
    physics_constructor_proxy::ConstructProcess()
    {
      pc->ConstructProcess();
      return;
    }
    ...
    void
    physics_list_proxy::ConstructParticle()
    {
    ...
    void
    physics_list_proxy::ConstructProcess()
    {
      pl->ConstructProcess();
      return;
    }
    ...
    void
    user_limits_info::make_step_limitation(double step_max_length_)
    {
      reset();

      DT_THROW_IF(step_max_length_ <= 0.0,
                  std::domain_error,
    ...
    void
    user_limits_info::make_track_limitation(double track_max_length_,
