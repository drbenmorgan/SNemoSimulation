...
namespace mctools {
  ...
  namespace g4 {
    ...
    const run_action&
    event_action::get_run_action() const
    {
      return *_run_action_;
    }

    run_action&
    event_action::grab_run_action()
    {
      return *_run_action_;
    }

    const ::mctools::simulated_data&
    event_action::get_event_data() const
    {
      if (_external_event_data_ != 0)
        return *_external_event_data_;
      return _event_data_;
    }

    ::mctools::simulated_data&
    event_action::grab_event_data()
    {
      if (_external_event_data_ != 0)
        return *_external_event_data_;
      return _event_data_;
    ...
    void
    event_action::set_external_event_data(::mctools::simulated_data& a_external_event_data)
    {
    ...
    bool
    event_action::is_initialized() const
    {
    ...
    void
    event_action::_at_init_()
    {
      return;
    }

    void
    event_action::_at_reset_()
    {
      return;
    }

    void
    event_action::initialize(const datatools::properties& config_)
    {
    ...
    bool
    event_action::is_save_only_tracked_events() const
    {
      return _save_only_tracked_events_;
    }

    bool
    event_action::is_aborted_event() const
    {
      return _aborted_event_;
    }

    void
    event_action::set_aborted_event(bool a_)
    {
      _aborted_event_ = a_;
      return;
    }
    ...
    bool
    event_action::is_killed_event() const
    {
      return _killed_event_;
    }

    void
    event_action::set_killed_event(bool k_)
    {
      _killed_event_ = k_;
      return;
    }
    ...
    void
    event_action::BeginOfEventAction(const G4Event* event_)
    {
    ...
    void
    event_action::EndOfEventAction(const G4Event* event_)
    {
      DT_LOG_TRACE_ENTERING(_logprio());
        ...
        if (draw_trajectory) {
          ...
          if (G4VVisManager::GetConcreteInstance()) {
            for (int i = 0; i < n_trajectories; i++) {
              G4Trajectory* trj = (G4Trajectory*)((*(event_->GetTrajectoryContainer()))[i]);
              trj->DrawTrajectory();
            }
          }
        }
    ...
    void
    event_action::_clear_hits_collections_(const G4Event* event_)
    {
    ...
    void
    event_action::_process_sensitive_hits_(const G4Event* event_, bool& save_this_event_)
    {
      ...
      for (int i = 0; i < (int)HCE->GetCapacity(); i++) {
        ...
        if (hc != 0) {
          DT_LOG_DEBUG(_logprio(),
                       "Hit collection '" << hc->GetName() << "' for sensitive detector '"
                                          << hc->GetSDname() << "' @ " << hc);
        }
      }
