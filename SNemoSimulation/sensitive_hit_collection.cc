...
namespace mctools {
  ...
  namespace g4 {
    ...
    sensitive_hit_collection::sensitive_hit_collection() { return; }
    ...
    G4int
    sensitive_hit_collection::operator==(const sensitive_hit_collection& right) const
    {
    ...
    G4VHit*
    sensitive_hit_collection::GetHit(size_t a_index) const
    {
      return _hits[a_index];
    }

    size_t
    sensitive_hit_collection::GetSize() const
    {
      return _hits.size();
    }
