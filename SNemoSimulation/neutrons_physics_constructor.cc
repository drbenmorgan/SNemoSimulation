...
// Ourselves:
#include <SNemoSimulation/neutrons_physics_constructor.h>
...
namespace snemo {
  ...
  namespace g4 {
    ...
    void
    neutrons_physics_constructor::initialize(const datatools::properties& config_,
                                             physics_constructor_dict_type& /*dict_*/)
    {
      ...
      DT_LOG_DEBUG(_logprio(),
                   "Use neutrons inelastic process: " << _use_neutrons_inelastic_process_);
      ...
      DT_LOG_DEBUG(_logprio(),
                   "Use protons inelastic process: " << _use_protons_inelastic_process_);
      ...
      DT_LOG_DEBUG(_logprio(),
                   "Use electrons-hadrons process: " << _use_electrons_hadronic_process_);
    ...
    void
    neutrons_physics_constructor::_set_defaults()
    {
      _use_HE_ = false;
    ...
    void
    neutrons_physics_constructor::reset()
    {
      DT_LOG_TRACE(_logprio(), "Entering...");
    ...
    void
    neutrons_physics_constructor::tree_dump(std::ostream& out_,
                                            ...
                                            bool /*inherit_*/) const
    {
      ...
      out_ << indent << datatools::i_tree_dumpable::tag << "Use neutrons inelastic process : "
      ...
      out_ << indent << datatools::i_tree_dumpable::tag
           ...
           << std::endl;
      out_ << indent << datatools::i_tree_dumpable::tag << "Use protons inelastic process  : "
           << (_use_protons_inelastic_process_ ? "Yes" : "No") << std::endl;
      out_ << indent << datatools::i_tree_dumpable::tag
           << "Use protons elastic process    : " << (_use_protons_elastic_process_ ? "Yes" : "No")
           << std::endl;
      out_ << indent << datatools::i_tree_dumpable::tag << "Use electrons hadronic process : "
    ...
    void
    neutrons_physics_constructor::ConstructParticle()
    {
      DT_THROW_IF(!is_initialized(), std::logic_error, "Not initialized !");
    ...
    void
    neutrons_physics_constructor::ConstructProcess()
    {
      DT_LOG_TRACE(_logprio(), "Entering...");
      DT_THROW_IF(!is_initialized(), std::logic_error, "Not initialized !");
      ...
      G4ExcitationHandler* the_handler = new G4ExcitationHandler();
      G4PreCompoundModel* the_pre_equilib = new G4PreCompoundModel(the_handler);
      the_cascade->SetDeExcitation(the_pre_equilib);
      QGSP_model->SetTransport(the_cascade);

      G4QGSMFragmentation* QGSM_fragmentation = new G4QGSMFragmentation();
      G4ExcitedStringDecay* the_string_decay = new G4ExcitedStringDecay(QGSM_fragmentation);
      ...
      while ((*theParticleIterator)()) {
        ...
        if (pname == "neutron") {
          ...
          if (_use_neutrons_elastic_process_) {
            ...
            the_neutron_elastic_process->AddDataSet(
              the_neutron_elastic_model->GiveHPXSectionDataSet());
    ...
    // static
    void
    neutrons_physics_constructor::init_ocd(datatools::object_configuration_description& ocd_)
    {
