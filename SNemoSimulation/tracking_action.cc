 ...
 */
DOCD_CLASS_IMPLEMENT_LOAD_BEGIN(snemo::g4::tracking_action, ocd_)
{
  // The class name :
  ocd_.set_class_name("snemo::g4::tracking_action");
...
DOCD_CLASS_SYSTEM_REGISTRATION(snemo::g4::tracking_action, "snemo::g4::tracking_action")
