...
#ifndef SNEMOSIMULATION_G4_NEUTRONS_PHYSICS_CONSTRUCTOR_H
#define SNEMOSIMULATION_G4_NEUTRONS_PHYSICS_CONSTRUCTOR_H 1
...
DOCD_CLASS_DECLARATION(snemo::g4::neutrons_physics_constructor)

#endif // SNEMOSIMULATION_G4_NEUTRONS_PHYSICS_CONSTRUCTOR_H
