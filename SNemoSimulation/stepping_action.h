...
#ifndef SNEMOSIMULATION_G4_STEPPING_ACTION_H
#define SNEMOSIMULATION_G4_STEPPING_ACTION_H 1
...
DOCD_CLASS_DECLARATION(snemo::g4::stepping_action)

#endif // SNEMOSIMULATION_G4_STEPPING_ACTION_H
